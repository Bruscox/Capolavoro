...
public class Pratica {
    ...
    public static void main(String[] args) {
        ...
        String[] livelliCompletati = new String[5];
        String[] livelliNonCompletati = new String[5];
        ...
        do {
            ...
            switch (scelta) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    risultato3 = risultato1 + risultato2 + risultato4 + risultato5;
                    if (risultato3 != 4) {
            ...
            if (risultato1 < 0 || risultato2 < 0 || finale < 0 || risultato4 < 0 || risultato5 < 0) {
                break;
            }
